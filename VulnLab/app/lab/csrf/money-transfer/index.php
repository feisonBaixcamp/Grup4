...
if (isset($_GET['transfer_amount']) && isset($_GET['receiver'])) {
    ...
    $transferAmount = filter_var($_GET['transfer_amount'], FILTER_VALIDATE_INT);

    if ($transferAmount > 0) {

        if ($selectUser_Info['money'] >= $transferAmount) {

            $sender_new_money = $selectUser_Info['money'] - $transferAmount;

            $db->beginTransaction();

            try {
                $sender_update = $db->prepare("UPDATE csrf_money_transfer SET money=:money WHERE authority=:authority");
                $sender_update->execute(array(
                ...
                <div class="col-md-6">
                    ...
                    <div class="card border-primary mb-3">
                        <div class="card-header text-primary">
                            ...
                            <div class="user-money" id="user-money">
