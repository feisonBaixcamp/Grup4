...
if (isset($_POST['uname']) && isset($_POST['passwd'])) {
    ...
    // Comprovar si les dades d'inici de sessió són correctes
    if ($username == $_POST['uname'] && $password == $_POST['passwd']) {
        // Redirigir a la pàgina d'inici si les dades són correctes
        header("Location: index.php");
    } else {
        // Redirigir a la pàgina de login si les dades són incorrectes
